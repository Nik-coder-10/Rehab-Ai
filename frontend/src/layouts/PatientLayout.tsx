...
export const PatientLayout: React.FC = () => {
  ...
  const navLinks = [
    ...
    { to: '/patient/exercises', label: 'Assigned Exercises', icon: Dumbbell },
    { to: '/patient/progress', label: 'Progress Analytics', icon: Activity },
    { to: '/patient/profile', label: 'Patient Profile', icon: UserIcon },
  ];
      ...
      >
        ...
        <div style={{ padding: '1.5rem 1.25rem', borderBottom: '1px solid var(--border-subtle)', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.72rem', color: 'var(--text-muted)', fontWeight: 500 }}>Patient Portal</p>
          </div>
        </div>
        ...
        <div style={{ padding: '1rem', borderTop: '1px solid var(--border-subtle)', backgroundColor: 'rgba(15, 23, 42, 0.4)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div style={{ overflow: 'hidden', flex: 1 }}>
              ...
              <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>Patient Mode</div>
            </div>
          </div>
          <button
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', fontWeight: 500 }}>
                Clinical Rehabilitation Hub
              </span>
            </div>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <span className="badge badge-teal">Care Team Connected</span>
          </div>
        </header>
              ...
              return (
                <NavLink
                  ...
                  style={({ isActive }) => ({
                    ...
                    borderRadius: 'var(--radius-md)',
                    backgroundColor: isActive ? 'rgba(20, 184, 166, 0.15)' : 'var(--bg-surface-elevated)',
                    color: isActive ? '#ffffff' : 'var(--text-secondary)',
                    textDecoration: 'none',
                    fontWeight: 600,
                  })}
